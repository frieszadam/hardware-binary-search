...
Functional verification was performed to ensure adherence to architectural specification and to analyze potential optimizations in reducing the number of states. A walkthrough of the process is available in pdf form: ![verification](functional-verification.pdf)
